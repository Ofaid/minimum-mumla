...
refresh every six hours from `MumlaApplication` without delaying startup. Actual Mumble connection,
room selection and token consumption are deliberately not wired yet.
